...
function formatPrice(price, options) {
    ...
    var _a = options.currency, currency = _a === void 0 ? "NGN" : _a, _b = options.notation, notation = _b === void 0 ? "compact" : _b;
